...
describe('slack threads tests', () => {
    ...
    it('should build readable Slack thread records', async () => {
            ...
            messages: [
                {
                    ...
                    reactions: [{ name: 'white_check_mark', actors: [{ name: 'Bob Builder', email: 'bob@example.com' }] }],
        ...
        expect(thread.body.includes('## 2023-11-14T22:15:00.123Z - Alice <alice@example.com>')).toBe(true);
        ...
        expect(thread.body.includes('- 2023-11-14T22:15:05.000Z - DeployBot - https://example.slack.com/files/F1')).toBe(true);
