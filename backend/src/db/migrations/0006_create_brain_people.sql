...
CREATE TABLE brain.people_data_sources (
  id                  uuid PRIMARY KEY DEFAULT uuidv7(),
  person_id           uuid NOT NULL REFERENCES brain.people (id),
  data_source_id      uuid NOT NULL REFERENCES brain.data_sources (id),
...
CREATE TABLE brain.records_people (
  record_id uuid NOT NULL REFERENCES brain.records (id) ON DELETE CASCADE,
  person_id uuid NOT NULL REFERENCES brain.people (id),
